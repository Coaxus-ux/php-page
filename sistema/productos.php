...
<body>
    ...
    <div class="overflow-x-auto mx-16 my-6">
        <a href="agregarProductos.php" class="btn btn-primary w-full mt-4 mb-3 hover:shadow-inner focus:outline-none transition duration-500 ease-in-out  transform hover:-translate-x hover:scale-105">
            Agregar productos
        </a>
