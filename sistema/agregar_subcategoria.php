...
if (!empty($_POST)) {
    ...
    if (empty($nombreCategoriaSubcategoria)) {
        ...
        $query_producto = mysqli_query($connection, "SELECT * FROM sublinea WHERE descripcion = '$nombreCategoriaSubcategoria'");
        ...
        <div class="flex-1 ">
            ...
            <label>Ya existe una SubCategoria con ese nombre.</label>
        </div>
        </div>';
        } else {
            $alert = false;
            ...
            <div class="flex-1 ">
                ...
                <label>Registro de la SubCategoria fallo.</label>
            </div>
            </div>';
            }
            if ($result_q) {
            ...
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z"></path>                
                ...
                <label>SubCategoria registrada con exito.</label>
            </div>
            </div>';
            }
        }
